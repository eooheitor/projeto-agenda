                ...
                <div class="p-6 text-gray-900">
                    <div class="container">
                        <div class="row">
                            ...
                            <div class="toast align-items-end text-white bg-danger border-0" role="alert" aria-live="assertive" aria-atomic="true" data-delay="{{ $index * 2000 }}" style="position: fixed; right: 15px;">
                                <div class="d-flex">
                            ...
                            @endif
                            @if (session('success'))
                            <div class="toast align-items-end text-white bg-success border-0" role="alert" aria-live="assertive" aria-atomic="true" data-delay="200" style="position: fixed; right: 15px;">
                                <div class="d-flex">
                                    <div class="toast-body">
                                        {{ session('success') }}
                                    </div>
                            ...
                            @endif
                            @if (session('error'))
                            <div class="toast align-items-end text-white bg-danger border-0" role="alert" aria-live="assertive" aria-atomic="true" data-delay="200" style="position: fixed; right: 15px;">
                                <div class="d-flex">
                                    <div class="toast-body">
                                        {{ session('error') }}
                                    </div>
                            ...
                            <div class="container">
                                ...
                                <form class="row g-3" method="post">
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <select id="" class="form-select" name="mesa" id="mesa" value="{{ old('mesa') }}">
